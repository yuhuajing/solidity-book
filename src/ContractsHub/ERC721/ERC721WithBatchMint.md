...
通过位图合约判断TokenID是否处于Burnt状态，通过checkPoint合约判断tokenID的归属

_mintConsecutive 直接顺序的mint NFT，通过_sequentialOwnership.lowerLookup 返回当前挖掘list中大于等于key值的第一个value地址，返回to地址。
...
import {IERC2309} from "https://github.com/OpenZeppelin/openzeppelin-contracts/blob/master/contracts/interfaces/IERC2309.sol";
import {BitMaps} from "https://github.com/OpenZeppelin/openzeppelin-contracts/blob/master/contracts/utils/structs/BitMaps.sol";
import {Checkpoints} from "https://github.com/OpenZeppelin/openzeppelin-contracts/blob/master/contracts/utils/structs/Checkpoints.sol";
 ...
 */
contract ERC721Consecutive is IERC2309, ERC721 {
    using BitMaps for BitMaps.BitMap;
    using Checkpoints for Checkpoints.Trace160;
    constructor(string memory name_, string memory symbol_) ERC721(name_,symbol_){
        _mint(msg.sender,79228162514264337593543950336);
    }
     ...
     */
    function _ownerOrf(uint256 tokenId) public view virtual returns (address) {
     ...
     */
    function _mintConsecutive(address to, uint96 batchSize) public virtual returns (uint96) {
